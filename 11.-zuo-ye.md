...
<figure><img src=".gitbook/assets/assignment_sample1.png" alt=""><figcaption></figcaption></figure>



`confirm.html` 完成示意：

<figure><img src=".gitbook/assets/assignment_sample2.png" alt=""><figcaption></figcaption></figure>
...
建立 **`html5/homework_座號`** 資料夾，**`座號`**請改成自己的實際座號，然後在該資料夾內，建立以下兩個檔案，檔名分別是 **`form.html`**、**`confirm.html`**。

然後確認本機端網址可以連，例： `http://127.0.0.1:5500/homework_01/form.html` 。
...
最晚繳交日期：**09/03(日)** 晚上 12 點之前。

先將 `homework_座號` 資料夾壓成壓縮檔，然後透過以下網址繳交：
...
[https://alldata.sgp1.digitaloceanspaces.com/sample/html5\_homework.zip](https://alldata.sgp1.digitaloceanspaces.com/sample/html5\_homework.zip)
